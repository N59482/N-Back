...
QT_MOC_LITERAL(1, 10, 13), // "restartSiganl"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 10), // "menuSignal"
QT_MOC_LITERAL(4, 36, 21), // "on_MenuButton_clicked"
QT_MOC_LITERAL(5, 58, 24) // "on_RestartButton_clicked"

    },
    "Statistic\0restartSiganl\0\0menuSignal\0"
    "on_MenuButton_clicked\0on_RestartButton_clicked"
};
...
void Statistic::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->restartSiganl(); break;
        case 1: _t->menuSignal(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Statistic::restartSiganl)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Statistic::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Statistic::menuSignal)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Statistic::staticMetaObject = { {
    ...
    qt_meta_stringdata_Statistic.data,
    qt_meta_data_Statistic,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void Statistic::restartSiganl()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Statistic::menuSignal()
{
